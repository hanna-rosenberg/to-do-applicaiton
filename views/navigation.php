<!-- <nav class="navbar">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a href="/noUser.php" class="nav-link <?php echo $_SERVER['SCRIPT_NAME'] === '/noUser.php' ? 'active' : ''; ?> ">No user</a>
        </li>
        <li class="nav-item">
            <a href="/AddUser.php" class="nav-link <?php echo $_SERVER['SCRIPT_NAME'] === '/AddUser.php' ? 'active' : ''; ?> ">Include</a>
        </li>
        ...
        <li class="nav-item">
            ...
            <?php else : ?>
                <a href="/Test.php" class="nav-link <?php echo $_SERVER['SCRIPT_NAME'] === '/Test.php' ? 'active' : ''; ?>">Log in</a>
            <?php endif; ?>
        </li>
